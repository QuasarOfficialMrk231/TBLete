# TBLete
## ПОДДЕРЖИВАЮТСЯ ТОЛЬКО SSD НАКОПИТЕЛИ, ДЛЯ HDD, И ДИСКА НУЖНЫ ДРУГИЕ СИСТЕМЫ.
...
**F6 + Right Shift + Delete + Ctrl одновременно всю комбинацию**
...
​Инструмент для мгновенного уничтожения данных и глубокой очистки системы при нажатии комбинации клавиш Ctrl + F6 + Right Shift + Delete (трижды всю комбинацию). Разработан для сценариев, когда необходимо полностью исключить возможность извлечения информации с устройства при физическом захвате.
...
#### Краткая инструкция:
**​Запишите образ на флешку и загрузитесь с неё. ​В GParted выберите диск и нажмите Device -> Create Partition Table -> gpt. ​Создайте новый раздел (New) и нажмите Apply.**
